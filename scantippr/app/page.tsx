      ...
      <main style={{ 
        ...
        <section style={{ padding: '60px 0', background: '#FFF' }}>
          <div className="responsive-container" style={{ 
            ...
            {/* Custom Desktop CSS Override injected here to force two columns side-by-side */}
            <style jsx>{`
              @media (min-width: 768px) {
                .hero-grid-split {
            ...
            <div className="hero-grid-split" style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '48px', width: '100%' }}>
        ...
        <section id="how-it-works" style={{ padding: '80px 0', background: '#F8FAFC' }}>
          <div className="responsive-container">
            ...
            <div style={{ 
              background: '#FFF', 
              borderRadius: '24px', 
              boxShadow: '0 20px 60px -20px rgba(15, 41, 66, 0.08)', 
              ...
              <img 
                src="/Dashboard.png" 
                alt="ScanTippr Corporate Dashboard Overview" 
                style={{ 
                  width: '100%', 
                  height: 'auto', 
                  display: 'block',
